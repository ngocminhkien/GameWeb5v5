 ...
 * Outer (T1), Inner (T2), Inhibitor (T3), and 1 Central Nexus Tower
 * 100% Symmetrical through Center (7500, 7500)
 */
export const TOWERS_CONFIG = [
  // ================= 10 BLUE TOWERS (ĐỘI XANH) =================
  // Mid Lane (Đẩy cao lên bảo vệ cửa sông Mid)
  ...
  // Top Lane (Đẩy cao lên sát ngã ba sông Top và Hốc đường trên)
  ...
  // Bot Lane (Đẩy cao sang phải sát ngã ba sông Bot và Hốc đường dưới)
  ...
  // 1 Trụ Nhà Chính Độc Nhất (Central Nexus Tower)
  { id: 'b_nexus', name: 'Trụ Nhà Chính Xanh', team: 'blue', x: 2000, y: 13000, hp: 6000 },

  // ================= 10 RED TOWERS (ĐỘI ĐỎ - ĐỐI XỨNG 15000 - x, 15000 - y) =================
  // Mid Lane
