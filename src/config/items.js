/**
 * Cấu hình dữ liệu 50 Trang Bị & Cửa Hàng MOBA (Item Shop Catalog)
 * Phân chia theo 3 Cấp bậc:
 * - Tier 1: Cơ bản / Thành phần nhỏ (12 món, 50g - 450g)
 * - Tier 2: Trung cấp / Nâng cao (17 món, 800g - 1200g)
 * - Tier 3: Hoàn chỉnh / Huyền thoại (18 món + 3 Dược phẩm, 2400g - 3600g)
 */
...
/**
 * Danh sách gợi ý lên trang bị cho Bot AI theo tiến trình Tier 1 -> Tier 2 -> Tier 3
 */
export const BOT_BUILD_PATHS = {
  AD: [
    'boots_basic',
    'long_sword',
    'vampiric_scepter',
