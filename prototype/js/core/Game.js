...
class Game {
  ...
  usePlayerSkill(slot) {
    ...
    if (slot === 'Q') {
      ...
      this.player.castDash(mouse.worldX, mouse.worldY, ROCK_WALLS, this.hud.addFloatingText.bind(this.hud));
    } else if (slot === 'R') {
      this.player.castUltimate(this.heroes, this.towers, this.monsters, this.minions, this.hud.addFloatingText.bind(this.hud), this.onKillReward.bind(this));
    } else if (slot === 'B') {
