/**
 * MapAssets.js (Prototype Version)
...
class MapAssets {
  ...
  drawRiverWithDepth(ctx, riverPolygon, camera, time = 0) {
    ...
    // 2. Translucent Flowing Water Body
...
window.MapAssets = MapAssets;
window.mapAssetsInstance = new MapAssets();
